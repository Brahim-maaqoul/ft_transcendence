...
const handelCreatGroup = () => 
{
  ...
  if (mutation.isSuccess) 
    ...
    function checkInfoCreatGroup() {
      ...
      <svg fill="#ffffff" height="16px" width="16px" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 460.775 460.775" xmlSpace="preserve" stroke="#ffffff">
        ...
        <p className='text-center text-2xl  text-white   font-mono leading-normal'>Creat New Group</p>
        <p className='text-gray-400 text-xs mt-2 font-mono leading-normal'> Give your new group Name you can always change it later.</p>
        </header>
        </div>

        { !isCreated && <div className='mt-6 '>
