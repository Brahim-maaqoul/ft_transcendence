...
import {  FaLinkedinIn,FaInstagram,FaGithub,FaTwitter,FaDribbble} from "react-icons/fa";
...
export default function Edit() {
  ...
  const handleSubmit = () => {
    ...
    mutation.mutate({ displayname: displayname, picture: avatar, bio: bio , nickname :nickname});
  };
  ...
  return (<div  className='flex justify-center items-center mt-10 '>
            <svg aria-hidden="true" className="w-6 h-6 mr-2 text-gray-200 animate-spin dark:text-gray-600 fill-[#18181B]" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  return (
    ...
    <div className="z-0 w-full md:w-[500px] h-[100vh] md:h-[700px] relative p-2 md:rounded-3xl bg-slate-500 bg-opacity-30  md:shadow-black md:shadow-2xl overflow-y-scroll no-scrollbar ">
        <div
          className=' w-full  overflow-auto h-full  md:bg-opacity-70 md:bg-slate-950   text-white  m-auto rounded-2xl p-10'
        >

          <div className='relative'>
            <div className="w-32 h-32 z-10 mx-auto">
                  <div className="h-32 w-32 rounded-full bg-cover    " style={{backgroundImage:`url(${dataUser?.picture!})`}}></div>
            </div>
            ...
            <div className='absolute left-[56%] top-[85px]  bg-[#ffff]   text-[#000000] rounded-full p-1'  >
              ...
              <TbPhotoEdit className="  cursor-pointer"  size={25}></TbPhotoEdit>
                ...
                <input className="hidden" id="image-upload" type="file" accept="image/*"  onChange={handleFileChange} />
            </div>
          </div>
