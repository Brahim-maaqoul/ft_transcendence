  ...
  return (
    <div className="absolute max-w-[1000px] max-h-[1000px] w-[100vw] h-[100vh]  top-0 left-0  bottom-0  right-0 content-center mx-auto m-7  bg-[#fff0]">
      <div className="h-full bg-[#fff0] relative flex flex-col justify-between  items-center">
        ...
        {/* <Body game={game}/> */}
        <div className="bg-[#000] relative max-w-[90%] max-h-[90%] w-[80vw] h-[65vh] mx-auto mb-4 mt-6 flex">
          <NavBar />
          <Body3D />
        </div>
        <div className="flex xl:hidden   mb-auto gap-6">
          <button
            className="bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 hover:bg-gradient-to-br 
                shadow-blue-500/50 dark:shadow-lg dark:shadow-blue-800/80 w-[16vw] h-[16vw] rounded-full content-center items-center "
          ></button>
          <button
            className="bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 hover:bg-gradient-to-br 
                shadow-blue-500/50 dark:shadow-lg dark:shadow-blue-800/80 w-[16vw] h-[16vw] rounded-full content-center items-center "
