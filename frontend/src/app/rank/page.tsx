          ...
          <div className="bg-black h-[887px] bg-opacity-40 rounded-2xl  p-4 m-2 overflow-y-auto no-scrollbar">
            ...
            <div className="flex justify-around">
              <div className="mt-16 flex flex-col items-center relative">
                ...
                <span className="text-gray-400 text-sm md:text-2xl mt-2">
                  USERNAME
                </span>
              ...
              <div className="flex flex-col items-center relative">
                ...
                <span className="text-amber-300 text-sm md:text-2xl mt-2">
                  USERNAME
                </span>
              ...
              <div className="mt-16 flex flex-col items-center relative">
                ...
                <span className="text-yellow-700 text-sm md:text-2xl mt-2">
                  USERNAME
                </span>
            ...
            {users.map((user, index) => (
              <div
                ...
                <div className="flex gap-x-4 items-center">
                  <span className="text-lg md:text-5xl text-slate-400 ">
                    #4
                  </span>
                  ...
                  <div className="flex flex-col">
                    <span className="text-slate-400 text-sm md:text-2xl">
                      YOUR RANK
                    </span>
